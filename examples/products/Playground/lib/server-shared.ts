...
export const DEFAULT_SERVER_SETTINGS: S = {
    ...
    // SwaggerUI local at http://localhost:8082 with docker run -p 8082:8080 -e SWAGGER_JSON_URL=http://localhost:7443/api/openapi.json swaggerapi/swagger-ui:v5.32.5
    // SwaggerUI online at https://editor.swagger.io
    server_cors_origins: [
        // SwaggerUI local with : docker run -p 8082:8080 -e SWAGGER_JSON_URL=http://localhost:7443/api/openapi.json swaggerapi/swagger-ui:v5.32.5
        'http://localhost:8082',
        // SwaggerUI online

...
import { type FileMetadataManager, type FSManager, type I18nManager, type PromptManager, type Worker } from '../../../std/index.js';
...
export declare class CommandExecutor implements Worker<Input, Promise<void>> {
    ...
    constructor(fsManager: FSManager, fileMetadataManager: FileMetadataManager, i18nManager: I18nManager, promptManager: PromptManager, ucManager: UCManager, wordingManager: WordingManager);
    ...
    private formatFilePathToFile;
    private formatUCInput;

...
import { UCBuilder, type UCDef, type UCInput, type UCName, type UCOPIBase } from '../uc/index.js';
...
import type { AppTesterExec, AppTesterExecArgs, AppTesterExecInput, AppTesterExecOutput } from './exec.js';
import type { AnyAppTesterFlow, AppTesterFlowExec } from './flow.js';
...
export declare class AppTester {
    ...
    execArgs(ucdRef: AppTesterUCDRef): Promise<AppTesterExecArgs[]>;
    execFlow(flow: AnyAppTesterFlow): Promise<AppTesterFlowExec>;
    execMonkeyTest<I extends UCInput | undefined = undefined, OPI0 extends UCOPIBase | undefined = undefined, OPI1 extends UCOPIBase | undefined = undefined>(ucd: UCDef<I, OPI0, OPI1>, input: NonNullable<I>): Promise<AppTesterExecOutput<I, OPI0, OPI1>>;
    execUC<I extends UCInput | undefined = undefined, OPI0 extends UCOPIBase | undefined = undefined, OPI1 extends UCOPIBase | undefined = undefined>(input: Omit<AppTesterExecInput<I, OPI0, OPI1>, 'appManifest'>, flow?: AnyAppTesterFlow): Promise<AppTesterExec<I, OPI0, OPI1>>;

...
export const UC_OUTPUT_SUFFIX = 'Output';
export const UC_OUTPUT_PART_SUFFIX = 'OutputPart';
export const UC_OUTPUT_PART0_SUFFIX = `${UC_OUTPUT_PART_SUFFIX}0`;
export const UC_OUTPUT_PART1_SUFFIX = `${UC_OUTPUT_PART_SUFFIX}1`;

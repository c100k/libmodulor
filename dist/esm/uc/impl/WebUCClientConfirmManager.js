...
let WebUCClientConfirmManager = class WebUCClientConfirmManager {
    wordingManager;
...
WebUCClientConfirmManager = __decorate([
    injectable(),
    __param(0, inject(WordingManager)),
    __metadata("design:paramtypes", [WordingManager])
], WebUCClientConfirmManager);
export { WebUCClientConfirmManager };

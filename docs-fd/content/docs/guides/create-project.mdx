...
<Callout>
    A project can contain multiple apps and products, even if they are not related.
</Callout>
...
If you don't want all the things handled automatically by `npx`, or if you want to add `libmodulor` to an existing project, you can install it manually.
